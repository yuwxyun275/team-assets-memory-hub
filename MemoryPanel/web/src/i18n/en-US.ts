...
export const enUS = {
  ...
  'task.edit': 'Edit',
  'task.edit.tooltip': 'Edit task details (title, description, acceptance criteria)',
  'task.save': 'Save',
  ...
  'task.descriptionPlaceholder': 'Describe the background, problem, and goal…',
  'task.acceptance': 'Acceptance criteria',
  'task.acceptanceHumanCriteria': 'Definition of done (one item per line)',
  'task.acceptanceMachineChecks': 'Machine-verifiable checks',
  'task.acceptanceTests': 'Required tests',
  'task.acceptancePaths': 'Target code paths',
  'task.acceptanceCodeChange': 'Observed code change required',
  'task.acceptanceAutoTests': 'Recommended after CodeBuddy starts, using team Skills and project tests',
  'task.acceptanceAutoPaths': 'Located after CodeBuddy starts, using the Code Graph',
  'task.acceptanceAutoCodeChange': 'Automatic (usually yes for Bug Fix/Feature, no for investigation/docs)',
  'task.acceptanceEmpty': 'No manual criteria are required. CodeBuddy will derive candidates and coverage gaps from the task, team assets, and repository tests.',
  'task.acceptanceRequired': 'Acceptance criteria are optional; the system can propose candidates.',
  'task.acceptancePassed': 'Passed',
  'task.acceptancePending': 'Pending',
  'task.acceptanceCandidateTitle': 'Proposed acceptance criteria',
  'task.acceptanceCandidateDescription': 'These guide test coverage but are not treated as business facts until an owner confirms them.',
  'task.acceptanceConfirm': 'Confirm criteria',
  'task.acceptanceConfirmed': 'The proposed criteria are now confirmed',
  'task.acceptanceConfirmedStatus': 'Confirmed',
  'task.acceptanceProposedStatus': 'Proposed',
  'task.acceptanceNotRequired': 'No extra acceptance required',
  ...
  'taskCreate.descriptionPlaceholder':
    'Describe the task background, current problem, and expected goal.',
  'taskCreate.repository': 'Code repository',
  'taskCreate.repositoryExtra': 'Optional but recommended. Use a local absolute path or Git URL so CodeBuddy cannot work in the wrong directory.',
  'taskCreate.repositoryPlaceholder': 'e.g. /Users/name/projects/service or https://github.com/org/repo.git',
  'task.repositoryUnbound': 'No repository bound; CodeBuddy will require workspace confirmation before editing.',
  'taskCreate.acceptance': 'Acceptance criteria',
  'taskCreate.acceptanceExtra': 'Optional. Enter your own criteria or adopt the candidates derived from the task description',
  'taskCreate.acceptancePlaceholder':
    'For example:\nFall back safely when Redis is unavailable\nNever read another tenant data\nNever expose draft flags',
  'taskCreate.acceptanceAdvanced': 'System recommendations (override only when needed)',
  'taskCreate.acceptanceSettings': 'Automatic acceptance checks',
  'taskCreate.acceptanceOverride': 'Override system recommendations (optional)',
  'taskCreate.acceptanceAutoHint': 'Leave these empty. After CodeBuddy binds the task, it infers them from the task text, Code Graph, team Skills, and historical assets. Values entered here override that inference.',
  'taskCreate.acceptanceCandidates': 'System-proposed criteria',
  'taskCreate.acceptanceAdopt': 'Adopt and edit',
  'taskCreate.acceptanceCandidateHint': 'Candidates help find test coverage gaps. Creating the task does not turn them into a business acceptance decision.',
  'taskCreate.requiredTests': 'Required tests',
  'taskCreate.requiredTestsExtra': 'Leave empty for recommendations; override only when test names are known',
  'taskCreate.requiredTestsPlaceholder': 'Leave empty to infer, or enter one test name per line',
  'taskCreate.targetPaths': 'Candidate code paths',
  'taskCreate.targetPathsExtra': 'Leave empty for Code Graph discovery; do not lock unknown paths too early',
  'taskCreate.targetPathsPlaceholder': 'Leave empty to infer, or enter one candidate file per line',
  'taskCreate.requireCodeChange': 'Must code be changed?',
  'taskCreate.autoInfer': 'Automatic (recommended)',
  'taskCreate.codeChangeRequired': 'Code change required',
  'taskCreate.codeChangeNotRequired': 'No code change required',
  ...
  'wiki.type.overview': 'Overview',
  'wiki.type.comparison': 'Comparison',
  'wiki.type.finding': 'Finding',
  'wiki.type.thesis': 'Thesis',
  'wiki.type.methodology': 'Methodology',
  'wiki.type.other': 'Other',
  'wiki.type.raw': 'Raw source',
  'wiki.type.purpose': 'Purpose',
  'wiki.type.schema': 'Schema',
