...
export interface TaskDetail {
  ...
  goal?: string;
  /** Repository URL/path bound by the task owner. */
  sourceUrl?: string;
  /** Source classification from Memory Hub (manual/github/tapd/other). */
  sourceType?: string;
  /** Opaque task metadata used by the local evidence service for acceptance policy. */
  metadataJson?: string;
}
