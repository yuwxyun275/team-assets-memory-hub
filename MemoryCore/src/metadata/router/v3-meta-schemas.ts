...
import { snapshotSchema } from "../../asset-quality/types.js";
...
export const assetQualityEvaluateSchema = z.object({
  snapshot: snapshotSchema,
  expected_asset_version: z.number().int().nonnegative().optional(),
}).strict();
export const assetQualityActionSchema = z.record(z.string(), z.unknown()).refine(v => typeof v.team_id === "string" && v.team_id.length > 0 && v.team_id.length <= 200);
...
export const V3_SCHEMAS = {
  ...
  "/v3/meta/asset/review": assetReviewSchema,
  "/v3/meta/asset/quality/evaluate": assetQualityEvaluateSchema,
